...
with st.sidebar:
    ...
    st.text_input("Host", value="roundhouse.proxy.rlwy.net", key="Host")
    st.text_input("Port", value="56022", key="Port")
    st.text_input("User", value="root", key="User")
    st.text_input("Password", type="password", value="JAkddSCgGWdcFVGuRAiOxdmBTHkGOcwQ", key="Password")
